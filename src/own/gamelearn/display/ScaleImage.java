 ...
 */
public class ScaleImage extends GameFrameControls {
    ...
    private void createTestImage() {
        ...
        g2d.fillRect(IMG_WIDTH, 0, IMG_WIDTH / 2, IMG_HEIGHT / 2);
        g2d.fillRect(IMG_WIDTH / 2, IMG_HEIGHT / 2, 0, IMG_HEIGHT);
        ...
        int dy = sprite.getHeight() / 18;
        for (int i = 0; i < sprite.getHeight(); i += dy) {
        ...
        g2d.drawString("Pg.1", sprite.getWidth() / 2 - 40, sprite.getHeight() / 2 - 40);
    ...
    private BufferedImage scaleDownImage(Object hintValues) {
        ...
        do {
            ...
            g2d.setRenderingHint(RenderingHints.KEY_INTERPOLATION, hintValues);
    ...
    protected void render(Graphics g) {
        super.render(g);
        g.drawImage(sprite, (appCanvas.getWidth() - sprite.getWidth()) / 2, 50, null);

        int sw = averaged.getWidth(null);
        int sh = averaged.getHeight(null);
        int pos = appCanvas.getHeight() - sh - 50;
        int textPos = pos + sh;
